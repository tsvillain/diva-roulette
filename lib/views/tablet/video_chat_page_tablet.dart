...
class VideoChatPageTablet extends StatefulWidget {
  @override
  _VideoChatPageTabletState createState() => _VideoChatPageTabletState();
}

class _VideoChatPageTabletState extends State<VideoChatPageTablet> {
