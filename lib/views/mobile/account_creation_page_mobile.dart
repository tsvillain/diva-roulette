...
import 'package:diva_roulette/views/mobile/verify_dialog_mobile.dart';
...
class AccountCreationPageMobile extends StatefulWidget {
  ...
  @override
  _AccountCreationPageMobileState createState() =>
      _AccountCreationPageMobileState();
}

class _AccountCreationPageMobileState extends State<AccountCreationPageMobile> {
  final dummyList = [
    "someone",
    "number",
    "moring",
